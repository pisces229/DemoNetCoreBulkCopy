...
CREATE TABLE [dbo].[table01](
	...
	[update_code] [varchar](10) NOT NULL,
...
GO
ALTER TABLE [dbo].[table01] ADD  CONSTRAINT [df__table01__create_code]  DEFAULT ('') FOR [create_code]
GO
ALTER TABLE [dbo].[table01] ADD  CONSTRAINT [df__table01__update_code]  DEFAULT ('') FOR [update_code]
GO
...
GO
ALTER TABLE [dbo].[table02] ADD  CONSTRAINT [df__table02__create_code]  DEFAULT ('') FOR [create_code]
GO
ALTER TABLE [dbo].[table02] ADD  CONSTRAINT [df__table02__update_code]  DEFAULT ('') FOR [update_code]
GO

-- INDEX
CREATE UNIQUE NONCLUSTERED INDEX [ak__table01] ON [dbo].[table01]
(
	[pkno] ASC
